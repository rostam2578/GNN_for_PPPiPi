...
fig.colorbar(ax3.matshow(sitonsquare(result1.reshape(6796) > samthr[0]), aspect=2, extent=[0, 288, 0, 43], origin='lower')\
                ,fraction=0.014)
plt.xlabel('cell')
plt.ylabel('layer')
plt.xlim(0, 288)
plt.ylim(0, 43)
plt.title(f'event number {EvBTr} passed through network after training. Threshold is {samthr[0]} \n color indicates time')
...
fig.colorbar(ax6.matshow(sitonsquare(result2.reshape(2, 6796)[0] > samthr[1]), aspect=2, extent=[0, 288, 0, 43], origin='lower')\
                ,fraction=0.014)
plt.xlabel('cell')
plt.ylabel('layer')
plt.xlim(0, 288)
plt.ylim(0, 43)
plt.title(f'event {EvBTr + 10} passed through network in a batch after training. Threshold is {samthr[1]} \n color indicates time')
...
fig.colorbar(ax9.matshow(sitonsquare(result2.reshape(2, 6796)[1] > samthr[2]), aspect=2, extent=[0, 288, 0, 43], origin='lower')\
                ,fraction=0.014)
plt.xlabel('cell')
plt.ylabel('layer')
plt.xlim(0, 288)
plt.ylim(0, 43)
plt.title(f'event {EvBTr + 11} passed through network in a batch after training. Threshold is {samthr[2]} \n color indicates time')
