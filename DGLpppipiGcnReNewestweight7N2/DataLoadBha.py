...
traingnnpppipi = cp.load('/hpcfs/bes/mlgpu/hoseinkk/MLTracking/bhabha/bhabha-files/traingnn80.npy')
trvalgnnpppipi = cp.load('/hpcfs/bes/mlgpu/hoseinkk/MLTracking/bhabha/bhabha-files/trvalgnn80.npy')
...
sqevent = np.zeros(shape=(43, 288)).get()
wiresum = np.zeros(shape = 44, dtype=int).get()
