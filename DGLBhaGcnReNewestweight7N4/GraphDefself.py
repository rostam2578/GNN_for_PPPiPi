...
# add self loop
dglgraph = dgl.add_self_loop(dglgraph, fill_data='max')
#dglgraph.edata['efet'] = dglgraph.edata['efet'].requires_grad_()
...
dglgraph.edata['efet'] = torch.ones((36593 * 2 + 6796, 1), requires_grad=True, device=device)
